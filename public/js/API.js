...
var tbody = tabla.childNodes[3];
var name_errors = document.querySelector('#name_errors');
var pag = document.querySelector('#pag');
var item_id = 0;
var pagina = 1; // localhost:8000
// Metodos crud
// crear

var create = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
    var curso, response, errors, listado_errores;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 4;
            return axios.post('/cursos/create', curso);
          ...
          case 8:
            ...
            listado_errores = errors.name.map(function (item) {
              var text = document.createTextNode = item;
              return text;
            });
            name_errors.append.apply(name_errors, _toConsumableArray(listado_errores));
...
var listar = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee2() {
    var pagina_index, response;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            pagina_index = localStorage.getItem('pagina');
            _context2.next = 4;
            return axios.get("/cursos?page=".concat(pagina_index));
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 5;
            return axios.put("/cursos/update/".concat(id), curso);
...
var deleteCurso = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            id = item_id;
            _context4.next = 4;
            return axios["delete"]("/cursos/destroy/".concat(id));
  ...
  return function deleteCurso() {
    return _ref4.apply(this, arguments);
  };
}();

var createLi = function createLi(data) {
  var listado = data.map(function (item) {
    var li = document.createElement('li');
    li.textContent = item.name;
    var btn_ed = document.createElement('button');
    ...
    var arr = [btn_ed, btn_d];
    li.append.apply(li, arr);
    return li;
  });
  return listado;
};

var createTr = function createTr(data) {
  var listado = data.map(function (item) {
    ...
    var arr = [text, btn_ed, espacio, btn_d];
    var arrtd = [td_id, td];
    td.append.apply(td, arr);
    tr.append.apply(tr, arrtd);
    return tr;
  });
  return listado;
};

var createPag = function createPag(last_page) {
  var page_items = _toConsumableArray(Array(last_page)).map(function (item, index) {
    var li = document.createElement('li');
  ...
  pag.append.apply(pag, _toConsumableArray(page_items));
};
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee8$(_context8) {
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            rePaginar = _args8.length > 0 && _args8[0] !== undefined ? _args8[0] : true;
          ...
          case 4:
            ...
            d = response.data.data.data;
            trs = createTr(d);
            tbody.innerHTML = '';
            tbody.append.apply(tbody, _toConsumableArray(trs)); // crear pág
...
var handleClick = /*#__PURE__*/function () {
  var _ref9 = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee9(e) {
    var button, text, id, alerta, response, _text, _id;
      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          case 0:
            ...
            text = button.parentNode.childNodes[0].textContent;
            id = button.dataset.id;
            alerta = sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire({
          ...
          case 9:
            if (button.classList.contains('editar')) {
              _text = button.parentNode.childNodes[0].textContent;
...
var handleClickPage = /*#__PURE__*/function () {
  var _ref10 = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee10(e) {
    var button, pg;
  ...
  return function handleClickPage(_x2) {
